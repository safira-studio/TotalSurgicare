    ...
    <section className="py-16 px-4 bg-white">
      <div className="container mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <h3 className="text-xl md:text-2xl font-bold text-clinic-dark mb-6">
              ...
              {corporateFeatures.map((feature, index) => (
                <div key={index} className="flex items-start space-x-3">
                  <div className="bg-blue-100 w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0">
                    <feature.icon className="h-5 w-5 text-clinic-dark" />
                  </div>
                  <div>
                    <h4 className="font-semibold text-clinic-dark mb-1">
                      {feature.title}
                    </h4>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-8">
            <div className="text-center mb-6">
              <Building className="h-16 w-16 text-clinic-dark mx-auto mb-4" />
              <h3 className="text-xl font-bold text-clinic-dark">
                Health Partnership
              </h3>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="font-bold text-clinic-dark">500+</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Employees Tested</span>
                <span className="font-bold text-clinic-dark">50,000+</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Satisfaction Rate</span>
                <span className="font-bold text-clinic-dark">98%</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          <h3 className="text-2xl font-onest text-clinic-dark text-center mb-8">
            Health Packages
          </h3>
            ...
            {packages.map((pkg, index) => (
              ...
              >
                <CardHeader className="text-center">
                  ...
                  <div className="mt-4">
                    <span className="text-3xl font-bold text-clinic-dark">
                      {pkg.price}
                    </span>
